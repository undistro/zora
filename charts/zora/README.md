...
![Version: 0.4.3](https://img.shields.io/badge/Version-0.4.3-informational?style=flat-square&color=3CA9DD) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square&color=3CA9DD) ![AppVersion: v0.4.3](https://img.shields.io/badge/AppVersion-v0.4.3-informational?style=flat-square&color=3CA9DD)
...
| scan.plugins.popeye.skipInternalResources | bool | `false` | Specifies whether the internal resources should be skipped by `popeye` scans. If `true` resources from `kube-system`, `kube-public` and `kube-node-lease` namespaces are skipped as well as the kubernetes system reserved RBAC (prefixed with `system:`). See `popeye` configuration file that is used for this case: https://github.com/undistro/zora/blob/main/charts/zora/popeye/spinach.yaml |
