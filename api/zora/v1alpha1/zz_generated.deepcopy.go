...
func (in *CheckMatch) DeepCopyInto(out *CheckMatch) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckMatch.
func (in *CheckMatch) DeepCopy() *CheckMatch {
	if in == nil {
		return nil
	}
	out := new(CheckMatch)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckValidation) DeepCopyInto(out *CheckValidation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckValidation.
func (in *CheckValidation) DeepCopy() *CheckValidation {
	if in == nil {
		return nil
	}
	out := new(CheckValidation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomCheckSpec) DeepCopyInto(out *CustomCheckSpec) {
	*out = *in
	...
	if in.Validations != nil {
		...
		*out = make([]CheckValidation, len(*in))
		copy(*out, *in)
	}
