...
func (in *ClusterScanStatus) DeepCopyInto(out *ClusterScanStatus) {
	*out = *in
	...
	if in.ProcessedVulnerabilities != nil {
		in, out := &in.ProcessedVulnerabilities, &out.ProcessedVulnerabilities
		*out = make(map[string]PluginScanProcessedResources, len(*in))
		for key, val := range *in {
			...
			if val == nil {
				...
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = make(PluginScanProcessedResources, len(*in))
				for key, val := range *in {
					(*out)[key] = val
				}
			}
	...
	if in.ProcessedMisconfigurations != nil {
		in, out := &in.ProcessedMisconfigurations, &out.ProcessedMisconfigurations
		*out = make(map[string]PluginScanProcessedResources, len(*in))
		for key, val := range *in {
			var outVal map[string]string
			if val == nil {
	...
	if in.ProcessedPluginStatus != nil {
		in, out := &in.ProcessedPluginStatus, &out.ProcessedPluginStatus
		*out = make(map[string]*PluginScanProcessedStatus, len(*in))
		for key, val := range *in {
			var outVal *PluginScanProcessedStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = new(PluginScanProcessedStatus)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in PluginScanProcessedResources) DeepCopyInto(out *PluginScanProcessedResources) {
	{
		in := &in
		*out = make(PluginScanProcessedResources, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginScanProcessedResources.
func (in PluginScanProcessedResources) DeepCopy() PluginScanProcessedResources {
	if in == nil {
		return nil
	}
	out := new(PluginScanProcessedResources)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PluginScanProcessedStatus) DeepCopyInto(out *PluginScanProcessedStatus) {
	*out = *in
	if in.Scan != nil {
		in, out := &in.Scan, &out.Scan
		*out = new(ProcessedScanStatus)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginScanProcessedStatus.
func (in *PluginScanProcessedStatus) DeepCopy() *PluginScanProcessedStatus {
	if in == nil {
		return nil
	}
	out := new(PluginScanProcessedStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessedScanStatus) DeepCopyInto(out *ProcessedScanStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessedScanStatus.
func (in *ProcessedScanStatus) DeepCopy() *ProcessedScanStatus {
	if in == nil {
		return nil
	}
	out := new(ProcessedScanStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VulnerabilityCommon) DeepCopyInto(out *VulnerabilityCommon) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VulnerabilityCommon.
func (in *VulnerabilityCommon) DeepCopy() *VulnerabilityCommon {
	if in == nil {
		return nil
	}
	out := new(VulnerabilityCommon)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VulnerabilityReportCommon) DeepCopyInto(out *VulnerabilityReportCommon) {
	*out = *in
	if in.Tags != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VulnerabilityReportCommon.
func (in *VulnerabilityReportCommon) DeepCopy() *VulnerabilityReportCommon {
	if in == nil {
		return nil
	}
	out := new(VulnerabilityReportCommon)
	in.DeepCopyInto(out)
	return out
}
