...
func (in *ClusterScanStatus) DeepCopyInto(out *ClusterScanStatus) {
	*out = *in
	...
	if in.PluginStatus != nil {
		...
		*out = make(map[string]*PluginCronJobStatus, len(*in))
		for key, val := range *in {
			var outVal *PluginCronJobStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(PluginCronJobStatus)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PluginCronJobStatus) DeepCopyInto(out *PluginCronJobStatus) {
	*out = *in
	if in.LastScheduleTime != nil {
		in, out := &in.LastScheduleTime, &out.LastScheduleTime
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginCronJobStatus.
func (in *PluginCronJobStatus) DeepCopy() *PluginCronJobStatus {
	if in == nil {
		return nil
	}
	out := new(PluginCronJobStatus)
