...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterIssueOverride) DeepCopyInto(out *ClusterIssueOverride) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterIssueOverride.
func (in *ClusterIssueOverride) DeepCopy() *ClusterIssueOverride {
	if in == nil {
		return nil
	}
	out := new(ClusterIssueOverride)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ClusterIssueOverride) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterIssueOverrideList) DeepCopyInto(out *ClusterIssueOverrideList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ClusterIssueOverride, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterIssueOverrideList.
func (in *ClusterIssueOverrideList) DeepCopy() *ClusterIssueOverrideList {
	if in == nil {
		return nil
	}
	out := new(ClusterIssueOverrideList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ClusterIssueOverrideList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterIssueOverrideSpec) DeepCopyInto(out *ClusterIssueOverrideSpec) {
	*out = *in
	if in.Clusters != nil {
		in, out := &in.Clusters, &out.Clusters
		*out = make([]NameNs, len(*in))
		copy(*out, *in)
	}
	if in.Message != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterIssueOverrideSpec.
func (in *ClusterIssueOverrideSpec) DeepCopy() *ClusterIssueOverrideSpec {
	if in == nil {
		return nil
	}
	out := new(ClusterIssueOverrideSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterIssueOverrideStatus) DeepCopyInto(out *ClusterIssueOverrideStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterIssueOverrideStatus.
func (in *ClusterIssueOverrideStatus) DeepCopy() *ClusterIssueOverrideStatus {
	if in == nil {
		return nil
	}
	out := new(ClusterIssueOverrideStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterIssueStatus) DeepCopyInto(out *ClusterIssueStatus) {
	*out = *in
	if in.OrigMessage != nil {
		in, out := &in.OrigMessage, &out.OrigMessage
		*out = new(string)
		**out = **in
	}
	if in.OrigSeverity != nil {
		in, out := &in.OrigSeverity, &out.OrigSeverity
		*out = new(ClusterIssueSeverity)
		**out = **in
	}
	if in.OrigCategory != nil {
		in, out := &in.OrigCategory, &out.OrigCategory
		*out = new(string)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NameNs) DeepCopyInto(out *NameNs) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NameNs.
func (in *NameNs) DeepCopy() *NameNs {
	if in == nil {
		return nil
	}
	out := new(NameNs)
