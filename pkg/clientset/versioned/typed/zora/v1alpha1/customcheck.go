...
func newCustomChecks(c *ZoraV1alpha1Client, namespace string) *customChecks {
	return &customChecks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *customChecks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CustomCheck, err error) {
	result = &v1alpha1.CustomCheck{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customChecks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CustomCheckList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CustomCheckList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("customchecks").
...
func (c *customChecks) Create(ctx context.Context, customCheck *v1alpha1.CustomCheck, opts v1.CreateOptions) (result *v1alpha1.CustomCheck, err error) {
	result = &v1alpha1.CustomCheck{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customchecks").
...
func (c *customChecks) Update(ctx context.Context, customCheck *v1alpha1.CustomCheck, opts v1.UpdateOptions) (result *v1alpha1.CustomCheck, err error) {
	result = &v1alpha1.CustomCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customchecks").
...
func (c *customChecks) UpdateStatus(ctx context.Context, customCheck *v1alpha1.CustomCheck, opts v1.UpdateOptions) (result *v1alpha1.CustomCheck, err error) {
	result = &v1alpha1.CustomCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customchecks").
...
func (c *customChecks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CustomCheck, err error) {
	result = &v1alpha1.CustomCheck{}
