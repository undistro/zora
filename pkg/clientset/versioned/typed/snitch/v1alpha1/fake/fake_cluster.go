...
type FakeClusters struct {
	Fake *FakeSnitchV1alpha1
	ns   string
}

var clustersResource = schema.GroupVersionResource{Group: "snitch", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "snitch", Version: "v1alpha1", Kind: "Cluster"}
