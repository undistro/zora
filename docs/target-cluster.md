...
A setup [script](https://zora.undistro.io/targetcluster.sh) is also avaiable for this, which can be executed by any POSIX compliant shell:
...
| `TOKEN_VALUE`				| K8s generate token |
